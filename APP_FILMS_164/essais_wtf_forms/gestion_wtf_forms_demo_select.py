...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé sur la table "t_ecran"
    ...
    try:
        ...
        if request.method == "GET":
            ...
            for i in data_genres:
                genre_val_list_dropdown.append(i['designation_ecran'])

            # Aussi possible d'avoir un id numérique et un texte en correspondance
            # genre_val_list_dropdown = [(i["id_ecran"], i["designation_ecran"]) for i in data_genres]
