...
def edit_genre_film_selected():
    if request.method == "GET":
        try:
            ...
            lst_data_genres_films_non_attribues = [item['id_ecran'] for item in data_genres_films_non_attribues]
            ...
            lst_data_genres_films_old_attribues = [item['id_ecran'] for item in data_genres_films_attribues]
