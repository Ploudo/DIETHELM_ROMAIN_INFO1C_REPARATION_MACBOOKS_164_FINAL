...
from DIETHELM_ROMAIN_INFO1C_REPARATION_MACBOOKS_164_V3TABLES.database import database_tools

try:

    objet_dumpbd = database_tools.ToolsBd().load_dump_sql_bd_init()  # C'est là qu'est la merde
